...
CREATE UNIQUE INDEX "pcw_unique_idx" ON "path_claim_waiters" USING btree ("blocking_task_id","waiting_task_id","blocked_path");--> statement-breakpoint
CREATE INDEX "pcw_blocking_task_idx" ON "path_claim_waiters" USING btree ("blocking_task_id") WHERE "path_claim_waiters"."notified_at" IS NULL;--> statement-breakpoint
CREATE INDEX "path_claims_active_idx" ON "path_claims" USING btree ("workspace_id") WHERE "path_claims"."released_at" IS NULL;--> statement-breakpoint
