...
export type SecretPurpose = 'anthropic_api_key' | 'oauth_token' | 'codex_credential' | 'webhook_token' | 'custom' | 'mcp_credential' | 'mcp_connector_credential' | 'vercel_token' | 'pushover' | 'notify_webhook';
