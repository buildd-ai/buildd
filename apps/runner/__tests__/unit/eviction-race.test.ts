 ...
 *
 * Run: bun test apps/runner/__tests__/unit/eviction-race.test.ts
 */
...
mock.module('../../src/worker-store', () => ({
  ...
  loadTerminalWorkersCached: () => mockLoadAllWorkers().filter((w: LocalWorker) => w.status === 'done' || w.status === 'error'),
