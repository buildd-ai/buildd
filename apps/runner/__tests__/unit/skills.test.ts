/**
 * Unit tests for Skills system — syncSkillToLocal and frontmatter handling
 *
 * Run: bun test apps/runner/__tests__/unit/skills.test.ts
 *
 * Uses inline reimplementation of parseFrontmatter/ensureFrontmatter to avoid
 * mock.module conflicts with other test files that mock '../../src/skills.js'.
 */
