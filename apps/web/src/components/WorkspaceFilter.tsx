...
export function WorkspaceFilter({ workspaces, selectedId: selectedIdProp }: WorkspaceFilterProps) {
    ...
    <div className="border-t border-border-default">
      {wsNavLinks && (
        <div className="border-b border-border-default">
          <div className={`font-mono uppercase tracking-widest text-text-muted ${isMobile ? 'px-5 pt-3 pb-1 text-[11px]' : 'px-3 pt-2 pb-0.5 text-[11px] md:text-[10px]'}`}>
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      >
        <span className="text-[11px] md:text-[10px] uppercase tracking-widest text-text-muted leading-tight hidden md:block">WORKSPACE</span>
