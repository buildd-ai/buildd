...
**Status:** Partially — S1 (pure model and vocabulary) is built, with D2's single-derivation part deferred to S5; S2 (shared components, unwired) is built; S3–S7 are proposed.
