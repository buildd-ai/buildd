...
**Version documented**: 0.2.72 (CLI parity: v2.1.72, Mar 10 2026)

### Monorepo SDK Versions

| Package | Version | Notes |
|---------|---------|-------|
| `packages/core` | `>=0.2.72` | Current |
| `apps/runner` | `^0.2.72` | Current |
...
| [sdk-reference/features.md](sdk-reference/features.md) | All SDK features: Sandbox, 1M context, Plugins, Structured Outputs, Budget, Hooks (all 15 events incl. WorktreeCreate/Remove), MCP, Agent Teams, Memory, Checkpointing, Background Agents, task_progress events, remote-control, account env vars, session management (`listSessions`, `getSessionMessages`), auto-memory |
