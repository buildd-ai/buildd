...
**Version documented**: 0.2.55 (CLI parity: v2.1.55, Feb 25 2026)

### Monorepo SDK Versions

| Package | Version | Notes |
|---------|---------|-------|
| `packages/core` | `>=0.2.49` | Upgrade to `>=0.2.55` recommended |
| `apps/agent` | `>=0.2.49` | Upgrade to `>=0.2.55` recommended |
| `apps/local-ui` | `>=0.2.49` | Upgrade to `>=0.2.55` recommended |
...
| [sdk-reference/new-in-v0250-55.md](sdk-reference/new-in-v0250-55.md) | Features 38–52: WorktreeCreate/Remove hooks, account identity env vars, remote-control, memory leak fixes, headless perf, DISABLE_1M_CONTEXT, HTTP hooks security |
