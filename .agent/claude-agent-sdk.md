...
**Version documented**: 0.2.58 (CLI parity: v2.1.58, Feb 25 2026)

### Monorepo SDK Versions

| Package | Version | Notes |
|---------|---------|-------|
| `packages/core` | `>=0.2.58` | Current |
| `apps/agent` | `>=0.2.58` | Current |
| `apps/local-ui` | `>=0.2.58` | Current |
