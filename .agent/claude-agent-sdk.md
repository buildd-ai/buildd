...
| [sdk-reference/features.md](sdk-reference/features.md) | Features 2–31: Sandbox, 1M context, Plugins, Structured Outputs, Budget, Hooks (all types), MCP annotations, Agent Teams, Memory, Checkpointing, etc. |
